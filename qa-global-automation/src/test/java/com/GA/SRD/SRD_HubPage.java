...
public class SRD_HubPage extends Driver{
	...
	String desiredURL = Constant.SRD_HubPage;
	...
	@Test//(dependsOnMethods = {"verify_Pagination_SRD_HubPage"}, alwaysRun = true)
	public void verify_Banner_SRD_HubPage() throws IOException, InterruptedException{
	...
	public void verify_BreadCrumb_SRD_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_BreadCrumb_SRD_HubPage"}, alwaysRun = true)
	public void verify_Title_SRD_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_Title_SRD_HubPage"}, alwaysRun = true)
	public void verify_ArchiveDescription_SRD_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_ArchiveDescription_SRD_HubPage"}, alwaysRun = true)
	public void verify_BrowseByList_SRD_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_BrowseByList_SRD_HubPage"}, alwaysRun = true)
	public void verify_heroContainer_LinkWorking_SRD_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_heroContainer_LinkWorking_SRD_HubPage"}, alwaysRun = true)
	public void verify_heroContainer_ImageWorking_SRD_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_heroContainer_ImageWorking_SRD_HubPage"}, alwaysRun = true)
	public void verify_5By1_featuredPostsLinks_SRD_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_5By1_featuredPostsLinks_SRD_HubPage"}, alwaysRun = true)
	public void verify_5By1_featuredPostsImgs_SRD_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_5By1_featuredPostsImgs_SRD_HubPage"}, alwaysRun = true)
	public void verify_4By2_featuredPostsLinks_SRD_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_4By2_featuredPostsLinks_SRD_HubPage"}, alwaysRun = true)
	public void verify_4By2_featuredPostsImgs_SRD_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_4By2_featuredPostsImgs_SRD_HubPage"}, alwaysRun = true)
	public void verify_4By1_featuredPostsLinks_SRD_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_4By1_featuredPostsLinks_SRD_HubPage"}, alwaysRun = true)
	public void verify_4By1_featuredPostsImgs_SRD_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	/*@Test(dependsOnMethods = {"verify_4By1_featuredPostsImgs_SRD_HubPage"}, alwaysRun = true)
	public void verify_NewsletterSignUpPage_SRD_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_4By1_featuredPostsImgs_SRD_HubPage"}, alwaysRun = true)
	public void verify_Pagination_SRD_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		try
