...
public class SRD_VideoPage extends Driver{
	...
	@Test
	public void verify_VideoPlayerContainer_SRD_VideoPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_VideoPlayerContainer_SRD_VideoPage"}, alwaysRun = true)
	public void verify_VideoFeaturedPlaylistLinks_SRD_VideoPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_VideoFeaturedPlaylistLinks_SRD_VideoPage"}, alwaysRun = true)
	public void verify_VideoPlaylistThumbnailImages_SRD_VideoPage() throws IOException, InterruptedException {
