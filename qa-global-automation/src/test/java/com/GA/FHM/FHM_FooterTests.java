...
public class FHM_FooterTests extends Driver {
	...
	public void verify_NewsletterSignUpPage_FooterSection() throws IOException, InterruptedException
	{
		...
		//Test Step
		//globalPage.verifyIsElementAvailable(newsletterSignUpTitle, url, "Newspaper Title");
		//globalPage.verifyIsElementAvailable(newsletterSignUpTagLine, url, "Newspaper Tag Line");
		//globalPage.verifyIsVideoAvailable(newsletterSignUpInput, url, "Newspaper SignUp Input field");
		//globalPage.verifyIsVideoAvailable(newsletterSignUpImage, url, "Newspaper SignUp Image");
		//globalPage.verifyIsElementAvailable(newsletterSignUpButton, url, "Newspaper SignUp Button");
