...
public class FHM_VideoPage extends Driver{
	...
	@Test
	public void verify_VideoPlayerContainer_FHM_VideoPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_VideoPlayerContainer_FHM_VideoPage"}, alwaysRun = true)
	public void verify_VideoFeaturedPlaylistLinks_FHM_VideoPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_VideoFeaturedPlaylistLinks_FHM_VideoPage"}, alwaysRun = true)
	public void verify_VideoPlaylistThumbnailImages_FHM_VideoPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_VideoPlaylistThumbnailImages_FHM_VideoPage"}, alwaysRun = true)
	public void verify_VideoPlaylistSliders_FHM_VideoPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_VideoPlaylistSliders_FHM_VideoPage"}, alwaysRun = true)
	public void verify_PlaylistPreviousArrowBtn_FHM_VideoPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_PlaylistDots_FHM_VideoPage"}, alwaysRun = true)
	public void verify_PlaylistNextArrowBtn_FHM_VideoPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_PlaylistPreviousArrowBtn_FHM_VideoPage"}, alwaysRun = true)
	public void verify_PlaylistDots_FHM_VideoPage() throws IOException, InterruptedException {
