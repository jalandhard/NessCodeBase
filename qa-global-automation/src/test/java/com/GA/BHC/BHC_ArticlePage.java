...
public class BHC_ArticlePage extends Driver{
	...
	public void verify_BreadCrumb_BHC_ArticlePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		...
		String expectedBreadcrumbUrl = Constant.BHC_HomePage + "/" +breadcrumbText;
		//Test Step
		//Step 2 Verify Amazon Header Bidder is Running
		globalPage.verifyIsBreadCrumbAvailable(Constant.breadcrumbLocator, url);
	}

	@Test(dependsOnMethods = {"verify_BreadCrumb_BHC_ArticlePage"}, alwaysRun = true)
	public void verifyTitle_BHC_ArticlePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verifyTitle_BHC_ArticlePage"}, alwaysRun = true)
	public void verifyLineTest_BHC_ArticlePage() throws InterruptedException, IOException{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	 ...
	 /*@Test(dependsOnMethods = {"verifyLineTest_BHC_ArticlePage"}, alwaysRun = true)
	public void verifyNavigate_PostAuthorPageFrom_BHC_ArticlePage() throws InterruptedException, IOException{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		...
		if(desiredUrl.contains(Constant.BHC_authorPage)==true && flag ==false){
			...
			assertTrue(desiredUrl.contains(Constant.BHC_authorPage),element +" is not available and working successfully on site :"+url);
	...
	*/
	...
	@Test(dependsOnMethods = {"verifyLineTest_BHC_ArticlePage"}, alwaysRun = true)
	public void verifyDekTest_BHC_ArticlePage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verifyDekTest_BHC_ArticlePage"}, alwaysRun = true)
	public void verifyTaboolaSidebarTest_BHC_ArticlePage() throws InterruptedException, IOException {
	...
	@Test(dependsOnMethods = {"verifyTaboolaSidebarTest_BHC_ArticlePage"}, alwaysRun = true)
	public void verify_SidebarAdWrapper_BHC_ArticlePage() throws InterruptedException, IOException {
	...
	@Test(dependsOnMethods = {"verify_SidebarAdWrapper_BHC_ArticlePage"}, alwaysRun = true)
	public void verifySocialShareLinks_BHC_ArticlePage() throws IOException, InterruptedException
	{
			//Object Initialization
				GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	/*@Test(dependsOnMethods = {"verifySocialShareLinks_BHC_ArticlePage"}, alwaysRun = true)
	public void newsletterSignUpTest_BHC_ArticlePage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	/*@Test(dependsOnMethods = {"verifySocialShareLinks_BHC_ArticlePage"}, alwaysRun = true)
	public void verifyFacebookLink_BHC_ArticlePage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verifyFacebookLink_BHC_ArticlePage"}, alwaysRun = true)
	public void verifyTwitterLink_BHC_ArticlePage() throws InterruptedException, IOException {
	...
	@Test(dependsOnMethods = {"verifyTwitterLink_BHC_ArticlePage"}, alwaysRun = true)
	public void verifyPinteresttLink_BHC_ArticlePage() throws InterruptedException, IOException {
