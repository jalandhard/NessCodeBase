...
public class BHC_ListiclePage extends Driver{
	...
	@Test
	public void verifyTitle_BHC_ListiclePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verifyTitle_BHC_ListiclePage"}, alwaysRun = true)
	public void verifyLineTest_BHC_ListiclePage() throws InterruptedException, IOException{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verifyLineTest_BHC_ListiclePage"}, alwaysRun = true)
	public void verifyDekTest_BHC_ListiclePage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verifyDekTest_BHC_ListiclePage"}, alwaysRun = true)
	public void verifycardImage_BHC_ListiclePage() throws InterruptedException, IOException {
	...
	@Test(dependsOnMethods = {"verifycardImage_BHC_ListiclePage"}, alwaysRun = true)
	public void verifycardPageCount_BHC_ListiclePage() throws InterruptedException, IOException {
	...
	/* No card credit on BHC
	@Test(dependsOnMethods = {"verifycardPageCount_BHC_ListiclePage"}, alwaysRun = true)
	public void verifycardImageCredit_BHC_ListiclePage() throws InterruptedException, IOException {
	...
	*/
	...
	@Test(dependsOnMethods = {"verifycardPageCount_BHC_ListiclePage"}, alwaysRun = true)
	public void verifycardTitle_BHC_ListiclePage() throws InterruptedException, IOException {
	...
	@Test(dependsOnMethods = {"verifycardTitle_BHC_ListiclePage"}, alwaysRun = true)
	public void verifycardCaption_BHC_ListiclePage() throws InterruptedException, IOException {
	...
	@Test(dependsOnMethods = {"verifycardCaption_BHC_ListiclePage"}, alwaysRun = true)
	...
	public void verifyTaboolaSidebar_BHC_ListiclePage() throws InterruptedException, IOException{
	...
	@Test(dependsOnMethods = {"verifyTaboolaSidebar_BHC_ListiclePage"}, alwaysRun = true)
	public void verifyTaboolaContainer_BHC_ListiclePage() throws InterruptedException, IOException{
