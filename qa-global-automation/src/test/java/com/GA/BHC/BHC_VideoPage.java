...
public class BHC_VideoPage extends Driver{
	...
	@Test
	public void verify_VideoPlayerContainer_BHC_VideoPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_VideoPlayerContainer_BHC_VideoPage"}, alwaysRun = true)
	public void verify_VideoFeaturedPlaylistLinks_BHC_VideoPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_VideoFeaturedPlaylistLinks_BHC_VideoPage"}, alwaysRun = true)
	public void verify_VideoPlaylistThumbnailImages_BHC_VideoPage() throws IOException, InterruptedException {
	...
	/* Not enough content
	@Test(dependsOnMethods = {"verify_VideoPlaylistThumbnailImages_BHC_VideoPage"}, alwaysRun = true)
	public void verify_VideoPlaylistSliders_BHC_VideoPage() throws IOException, InterruptedException {
	...
	*/
	...
	/* Lack of content
	@Test(dependsOnMethods = {"verify_VideoPlaylistSliders_BHC_VideoPage"}, alwaysRun = true)
	public void verify_PlaylistPreviousArrowBtn_BHC_VideoPage() throws IOException, InterruptedException {
	...
	*/
	...
	/*
	@Test//(dependsOnMethods = {"verify_PlaylistDots_BHC_VideoPage"}, alwaysRun = true)
	public void verify_PlaylistNextArrowBtn_BHC_VideoPage() throws IOException, InterruptedException {
	...
	*/
	...
	/* Not enough content on BHC
	@Test(dependsOnMethods = {"verify_PlaylistPreviousArrowBtn_BHC_VideoPage"}, alwaysRun = true)
	public void verify_PlaylistDots_BHC_VideoPage() throws IOException, InterruptedException {
