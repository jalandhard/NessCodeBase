...
public class HLT_FooterTests extends Driver {
	...
	private By socialIcons = By.xpath("//ul[@id='menu-footer-social']//a"); // By.xpath("//ul[@id='menu-tmbi-social-profiles']//a");
	...
	private By newsletterSignUpButton =  By.xpath("//div[@class='newsletter']//form"); //button[@id='subscribe']");  // By.xpath("//div[@class='pure-u-1 pure-u-md-2-5 right-foot']//form//button");
	...
	//List<String> url = Constant.HLT_list;
