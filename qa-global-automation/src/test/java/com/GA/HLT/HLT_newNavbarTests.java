...
public class HLT_newNavbarTests extends Driver{
	...
	private By SubscribeLink_header =By.xpath("//div[@class='sub-to-mag at-element-marker']//a"); 
	private By magazineImg_Header = By.xpath("//div[@class='sub-to-mag at-element-marker']//img");
	...
	private By hLT_hamburgerhavingChild=By.xpath("//ul/li[@class='menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children']//li[@class='menu-item menu-item-type-taxonomy menu-item-object-category']//a");
	...
	private By hamburgerMenuNoChildLinks=By.xpath("//li/div[1]/ul[1]/li[@class='menu-item menu-item-type-custom menu-item-object-custom at-element-marker']//a");
...
//	private By hamburgerCloseBtn = By.xpath("//div[@class='hamburger-wrapper mobile-hide']//div[@class='hamburger-close']");   //button[@id='toh-menu-toggle']
	...
	*/
	...
	@Test()
	public void verify_BrandLogo_HLT() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_BrandLogo_HLT"}, alwaysRun = true)
	public void NLSignUpImg_Header_HLT() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"NLSignUpImg_Header_HLT"}, alwaysRun = true)
	public void NLSignUp_Header_HLT() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"NLSignUp_Header_HLT"}, alwaysRun = true)
	public void verify_subsribleMagazineImg_Header_HLT() throws IOException, InterruptedException {
		...
		//globalPage.verifyIsElementWorking_HLT(heroText, url, element);
	...
	@Test(dependsOnMethods = {"verify_subsribleMagazineImg_Header_HLT"}, alwaysRun = true)
	public void verify_headerNavBars_HLT_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	/*@Test(dependsOnMethods = {"verify_headerNavBars_HLT_HomePage"}, alwaysRun = true)
	public void compare_Header_Categories_HLT_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		String element = "Header category link ";
		//Test Step
		globalPage.verifyheaderCategories(categoryLinks, url, element, Constant.HLT_Headers);
		
	}*/
	
	@Test(dependsOnMethods = {"verify_headerNavBars_HLT_HomePage"}, alwaysRun = true)
	public void verify_hamburgerMenu_Opened_HLT_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_hamburgerMenu_Opened_HLT_HomePage"}, alwaysRun = true)
	public void verify_hamburger_MainMenu_Categories_HLT_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_hamburger_MainMenu_Categories_HLT_HomePage"}, alwaysRun = true)
	public void verify_hamburgerMenusHavingChild_HLT_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		String element = "hamburger menu having child ";
		//Test Step;
		globalPage.brandLinksNavigation(hLT_hamburgerhavingChild, url, element);
			globalPage.brandLinksNavigation(hamburgerMenuhavingChildLinks, url, element);
			
	}
	
	@Test(dependsOnMethods = {"verify_hamburger_MainMenu_Categories_HLT_HomePage"}, alwaysRun = true)
	public void verify_hamburgerMenusHavingNoChild_HLT_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_hamburgerMenusHavingChild_HLT_HomePage"}, alwaysRun = true)
	public void verify_hamburgerMenu_Closed_HLT_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_hamburgerMenu_Closed_HLT_HomePage"}, alwaysRun = true)
	public void verify_NavBar_CategoryLinks_HLT_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		String element = "Header category link ";
		//Test Step
