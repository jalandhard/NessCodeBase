...
public class HLT_VideoPage extends Driver{
	...
	@Test
	public void verify_VideoPlayerContainer_HLT_VideoPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_VideoPlayerContainer_HLT_VideoPage"}, alwaysRun = true)
	public void verify_VideoFeaturedPlaylistLinks_HLT_VideoPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_VideoFeaturedPlaylistLinks_HLT_VideoPage"}, alwaysRun = true)
	public void verify_VideoPlaylistThumbnailImages_HLT_VideoPage() throws IOException, InterruptedException {
	...
	/* Lack of content
	@Test(dependsOnMethods = {"verify_VideoPlaylistThumbnailImages_HLT_VideoPage"}, alwaysRun = true)
	/*public void verify_VideoPlaylistSliders_HLT_VideoPage() throws IOException, InterruptedException {
	...
	*/
	...
	/* Not enough content
	@Test(dependsOnMethods = {"verify_VideoPlaylistSliders_HLT_VideoPage"}, alwaysRun = true)
	public void verify_PlaylistPreviousArrowBtn_HLT_VideoPage() throws IOException, InterruptedException {
	...
	*/
	...
	/* Not enough content
	@Test(dependsOnMethods = {"verify_PlaylistDots_HLT_VideoPage"}, alwaysRun = true)
	public void verify_PlaylistNextArrowBtn_HLT_VideoPage() throws IOException, InterruptedException {
	...
	*/
	...
	/* Not enough content
	@Test(dependsOnMethods = {"verify_PlaylistPreviousArrowBtn_HLT_VideoPage"}, alwaysRun = true)
	public void verify_PlaylistDots_HLT_VideoPage() throws IOException, InterruptedException {
