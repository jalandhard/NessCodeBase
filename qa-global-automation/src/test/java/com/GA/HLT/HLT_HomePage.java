...
public class HLT_HomePage extends Driver{
	...
	*///video container
	...
	private By secCustContainer = By.xpath("//div[@class='category-6']//h4//a"); //div[@class='content']//div[8]//h4//a"); //  //div[12]/ul[1]
	...
	/*private By secCustBigContainer = By.xpath("//div[@class='content']//div[8]//h4[@class='fancy']//a");
	private By secCustSmallContainer = By.xpath("//div[@class='content']//div[8]//div[@class='text-container']/h4//a");
	
	private By content2Ad = By.xpath("//iframe[@id='google_ads_iframe_/6178/hlt_desktop/homepage/content_2_0']");
	*/
	@BeforeClass
	...
	@Test()
	public void verify_HeroContainerPost_LinkWorking_HLT_HomePage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_HeroContainerPost_LinkWorking_HLT_HomePage"}, alwaysRun = true)
	public void verify_HeroContainerPost_ImageWorking_HLT_HomePage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_HeroContainerPost_ImageWorking_HLT_HomePage"}, alwaysRun = true)
	public void verify_SpotLightSection_Posts_HLT_HomePage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_SpotLightSection_Posts_HLT_HomePage"}, alwaysRun = true)
	public void verify_VideoContainerAvailable_HLT_HomePage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_VideoContainerAvailable_HLT_HomePage"}, alwaysRun = true)
	public void verify_VideosRunning_HLT_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_VideosRunning_HLT_HomePage"}, alwaysRun = true)
	public void verify_WatchMoreVideosLink_HLT_HomePage() throws IOException, InterruptedException {
...
/*	@Test(dependsOnMethods = {"verify_WatchMoreVideosLink_HLT_HomePage"}, alwaysRun = true)
	public void verify_NativeSponsor_Container_HLT_HomePage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_NativeSponsor_Container_HLT_HomePage"}, alwaysRun = true)
	public void verify_NativeSponsor_PostWorking_HLT_HomePage() throws IOException, InterruptedException {
...
*/
	...
	@Test(dependsOnMethods = {"verify_WatchMoreVideosLink_HLT_HomePage"}, alwaysRun = true)
	public void verify_2Big3Small_Container_Heading_HLT_HomePage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_2Big3Small_Container_Heading_HLT_HomePage"}, alwaysRun = true)
	public void verify_2Big3SmallPosts_Available_HLT_HomePage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_2Big3SmallPosts_Available_HLT_HomePage"}, alwaysRun = true)
	public void verify_2Big3SmallContainer_MoreButtons_Available_HLT_HomePage()throws IOException, InterruptedException{
	...
	@Test(dependsOnMethods = {"verify_2Big3SmallContainer_MoreButtons_Available_HLT_HomePage"}, alwaysRun = true)
	public void verify_1Big3SmallContainer_Heading_HLT_HomePage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_1Big3SmallContainer_Heading_HLT_HomePage"}, alwaysRun = true)
	public void verify_1Big3SmallPosts_Available_HLT_HomePage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	*/
	...
	@Test(dependsOnMethods = {"verify_1Big3SmallPosts_Available_HLT_HomePage"}, alwaysRun = true)
	public void verify_1Big3SmallContainer__MoreButtons_Availble_HLT_HomePage()throws IOException, InterruptedException{
