...
public class RDC_ListiclePage extends Driver{
	...
	@Test
	public void verifyTitle_RDC_ListiclePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verifyTitle_RDC_ListiclePage"}, alwaysRun = true)
	public void verifyLineTest_RDC_ListiclePage() throws InterruptedException, IOException{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	/*@Test(dependsOnMethods = {"verifyLineTest_RDC_ListiclePage"}, alwaysRun = true)
	public void verifyFacebookLink_RDC_ListiclePage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verifyFacebookLink_RDC_ListiclePage"}, alwaysRun = true)
	public void verifyTwitterLink_RDC_ListiclePage() throws InterruptedException, IOException {
	...
	@Test(dependsOnMethods = {"verifyTwitterLink_RDC_ListiclePage"}, alwaysRun = true)
	public void verifyPinteresttLink_RDC_ListiclePage() throws InterruptedException, IOException {
	 ...
	 */
	@Test(dependsOnMethods = {"verifyLineTest_RDC_ListiclePage"}, alwaysRun = true)
	public void verifyDekTest_RDC_ListiclePage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verifyDekTest_RDC_ListiclePage"}, alwaysRun = true)
	public void verifycardImage_RDC_ListiclePage() throws InterruptedException, IOException {
	...
	@Test(dependsOnMethods = {"verifycardImage_RDC_ListiclePage"}, alwaysRun = true)
	public void verifycardPageCount_RDC_ListiclePage() throws InterruptedException, IOException {
	...
	@Test(dependsOnMethods = {"verifycardPageCount_RDC_ListiclePage"}, alwaysRun = true)
	public void verifycardImageCredit_RDC_ListiclePage() throws InterruptedException, IOException {
	...
	@Test(dependsOnMethods = {"verifycardImageCredit_RDC_ListiclePage"}, alwaysRun = true)
	public void verifycardTitle_RDC_ListiclePage() throws InterruptedException, IOException {
	...
	@Test(dependsOnMethods = {"verifycardTitle_RDC_ListiclePage"}, alwaysRun = true)
	...
	public void verifyTaboolaSidebar_RDC_ListiclePage() throws InterruptedException, IOException{
	...
	@Test(dependsOnMethods = {"verifyTaboolaSidebar_RDC_ListiclePage"}, alwaysRun = true)
	public void verifyTaboolaContainer_RDC_ListiclePage() throws InterruptedException, IOException{
