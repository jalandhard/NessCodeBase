...
public class RDC_HomePage extends Driver{
...
*/	//spotlight container - 1big3small
	...
	*///video container
	...
	private By firstCustContainer = By.xpath("//div[@class='two-big-three-small']//h4//a");
	private By firstCustomHeading = By.xpath("//h2[@class='hp-section-heading rdc']//a");  //h2[2]/a[1]");
	...
	private By content2Ad = By.xpath("//iframe[@id='google_ads_iframe_/6178/rdca_desktop/homepage/content_2_0']");
	*/private By secCustomHeading = By.xpath("//div[@class='category-6']//h2//a");  //h2[3]//a");
	...
	@Test()
	public void verify_SpotLightSection_Posts_RDC_HomePage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_SpotLightSection_Posts_RDC_HomePage"}, alwaysRun = true)
	public void verify_VideoContainerAvailable_RDC_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_VideoContainerAvailable_RDC_HomePage"}, alwaysRun = true)
	public void verify_VideosRunning_RDC_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_VideosRunning_RDC_HomePage"}, alwaysRun = true)
	public void verify_WatchMoreVideosLink_RDC_HomePage() throws IOException, InterruptedException {
		//Object Initialization
	
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		String element = "Watch More videos link";
		//globalPage.verifyIsElementWorking_CA(moreVideosLink, url, element);
		globalPage.verifyPostsImages_Clickable(moreVideosLink, url);
		globalPage.verifyLinkStatus(moreVideosLink, url, element);
	}
	

	/*@Test(dependsOnMethods = {"verify_WatchMoreVideosLink_RDC_HomePage"}, alwaysRun = true)
	public void verify_NativeSponsor_Container_RDC_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_NativeSponsor_Container_RDC_HomePage"}, alwaysRun = true)
	public void verify_NativeSponsor_PostWorking_RDC_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
...
*/
	@Test(dependsOnMethods = {"verify_WatchMoreVideosLink_RDC_HomePage"}, alwaysRun = true)
	public void verify_2Big3Small_Container_Heading_RDC_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_2Big3Small_Container_Heading_RDC_HomePage"}, alwaysRun = true)
	public void verify_2Big3SmallPosts_Available_RDC_HomePage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_2Big3SmallPosts_Available_RDC_HomePage"}, alwaysRun = true)
	public void verify_2Big3SmallContainer_MoreButtons_Available_RDC_HomePage()throws IOException, InterruptedException{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_2Big3SmallContainer_MoreButtons_Available_RDC_HomePage"}, alwaysRun = true)
	public void verify_1Big3SmallContainer_Heading_RDC_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_1Big3SmallContainer_Heading_RDC_HomePage"}, alwaysRun = true)
	public void verify_1Big3SmallPosts_Available_RDC_HomePage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_1Big3SmallPosts_Available_RDC_HomePage"}, alwaysRun = true)
	public void verify_1Big3SmallContainer__MoreButtons_Availble_RDC_HomePage()throws IOException, InterruptedException{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
