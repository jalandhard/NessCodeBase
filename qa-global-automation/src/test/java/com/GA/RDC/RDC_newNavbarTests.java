...
public class RDC_newNavbarTests extends Driver{
	...
	private By hamburgerMenuhavingChildLinks=By.xpath("//ul/li[@class='menu-item menu-item-type-taxonomy menu-item-object-category menu-item-has-children']//li[contains(@class,'menu-item')]//a");
...
//	private By hamburgerCloseBtn = By.xpath("//div[@class='hamburger-wrapper mobile-hide']//div[@class='hamburger-close']");   //button[@id='toh-menu-toggle']
	...
	@Test()
	public void verify_BrandLogo_RDC() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_BrandLogo_RDC"}, alwaysRun = true)
	public void NLSignUpLink_Header_RDC() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"NLSignUpLink_Header_RDC"}, alwaysRun = true)
	public void verify_subsribleMagazineImg_Header_RDC() throws IOException, InterruptedException {
		...
		//globalPage.verifyIsElementWorking_RDC(heroText, url, element);
	...
	@Test(dependsOnMethods = {"verify_subsribleMagazineImg_Header_RDC"}, alwaysRun = true)
	public void verify_headerNavBars_RDC_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	/*@Test(dependsOnMethods = {"verify_headerNavBars_RDC_HomePage"}, alwaysRun = true)
	public void compare_Header_Categories_RDC_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		String element = "Header category link ";
		//Test Step
		globalPage.verifyheaderCategories(categoryLinks, url, element, Constant.RDC_Headers);
		
	}*/
	
	@Test(dependsOnMethods = {"verify_headerNavBars_RDC_HomePage"}, alwaysRun = true)
	public void verify_hamburgerMenu_Opened_RDC_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_hamburgerMenu_Opened_RDC_HomePage"}, alwaysRun = true)
	public void verify_hamburger_MainMenu_Categories_RDC_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_hamburger_MainMenu_Categories_RDC_HomePage"}, alwaysRun = true)
	public void verify_hamburgerMenusHavingChild_RDC_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_hamburger_MainMenu_Categories_RDC_HomePage"}, alwaysRun = true)
	public void verify_hamburgerMenusHavingNoChild_RDC_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_hamburgerMenusHavingChild_RDC_HomePage"}, alwaysRun = true)
	public void verify_hamburgerMenu_Closed_RDC_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_hamburgerMenu_Closed_RDC_HomePage"}, alwaysRun = true)
	public void verify_NavBar_CategoryLinks_RDC_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		String element = "Header category link ";
		//Test Step
