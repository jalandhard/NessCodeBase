...
public class RDC_FooterTests extends Driver {
	...
	private By newsletterSignUpButton = By.xpath("//div[@class='newsletter']//form");   //div[@class='pure-u-1 pure-u-md-2-5 right-foot']//form//button");
	...
	private By ourBrandsLocator = By.xpath("//ul[@class='footer-brand-links']//a");
