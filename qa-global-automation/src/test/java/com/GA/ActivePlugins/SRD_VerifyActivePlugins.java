...
public class SRD_VerifyActivePlugins extends Driver {
	...
	//Test Data
	String url=Constant.SRD_HomePage+"wp-json/plugins/v1/inactive/"; 
	...
	public void navigateToRequiredURL() throws Exception{
		...
		if(environment.equalsIgnoreCase("production")) {
			propertyFilePath = Paths.get(System.getProperty("user.dir"), "src", "test", "resources", "configs", "plugins_SRD.txt").toString();
		}
		else if (environment.equalsIgnoreCase("staging")) {
			propertyFilePath = Paths.get(System.getProperty("user.dir"), "src", "test", "resources", "configs", "plugins_preprod_SRD.txt").toString();
		}
	}
	...
	@Test
	public void verify_SRD_ActivePlugins() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_SRD_ActivePlugins"}, alwaysRun = true)
