...
public class RD_VerifyActivePlugins extends Driver{
	...
	//Test Data
	String url=Constant.RD_HomePage+"wp-json/plugins/v1/inactive/";
	...
	public void navigateToRequiredURL() throws Exception{
		...
		if(environment.equalsIgnoreCase("production")) {
			propertyFilePath = Paths.get(System.getProperty("user.dir"), "src", "test", "resources", "configs", "plugins_RD.txt").toString();
		}
		else if (environment.equalsIgnoreCase("staging")) {
			propertyFilePath = Paths.get(System.getProperty("user.dir"), "src", "test", "resources", "configs", "plugins_preprod_RD.txt").toString();
		}
	}
	...
	@Test
	public void verify_RD_ActivePlugins() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_RD_ActivePlugins"}, alwaysRun = true)
