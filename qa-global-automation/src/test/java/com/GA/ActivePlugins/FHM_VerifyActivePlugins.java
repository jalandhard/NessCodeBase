...
public class FHM_VerifyActivePlugins extends Driver {
	...
	//Test Data
	String url=Constant.FHM_HomePage+"wp-json/plugins/v1/inactive/";
	...
	public void navigateToRequiredURL() throws Exception{
		...
		if(environment.equalsIgnoreCase("production")) {
			propertyFilePath = Paths.get(System.getProperty("user.dir"), "src", "test", "resources", "configs", "plugins_FHM.txt").toString();
		}
		else if (environment.equalsIgnoreCase("staging")) {
			propertyFilePath = Paths.get(System.getProperty("user.dir"), "src", "test", "resources", "configs", "plugins_preprod_FHM.txt").toString();
		}
	}
	...
	@Test
	public void verify_FHM_ActivePlugins() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_FHM_ActivePlugins"}, alwaysRun = true)
