...
public class RDC_VerifyActivePlugins extends Driver {
	...
	//Test Data
	String url=Constant.RDC_HomePage+"wp-json/plugins/v1/inactive/";
	...
	public void navigateToRequiredURL() throws Exception{
		...
		if(environment.equalsIgnoreCase("production")) {
			propertyFilePath = Paths.get(System.getProperty("user.dir"), "src", "test", "resources", "configs", "plugins_RDC.txt").toString();
		}
		else if (environment.equalsIgnoreCase("staging")) {
			propertyFilePath = Paths.get(System.getProperty("user.dir"), "src", "test", "resources", "configs", "plugins_preprod_RDC.txt").toString();
		}
	}
	...
	@Test
	public void verify_RDC_ActivePlugins() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_RDC_ActivePlugins"}, alwaysRun = true)
