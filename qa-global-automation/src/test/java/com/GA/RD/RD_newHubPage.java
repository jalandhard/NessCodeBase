...
public class RD_newHubPage extends Driver {
	...
	String desiredURL = Constant.RD_HubPage;
	...
	@Test
	public void verify_Banner_RD_HubPage() throws IOException, InterruptedException{
	...
	public void verify_BreadCrumb_RD_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_BreadCrumb_RD_HubPage"}, alwaysRun = true)
	public void verify_Title_RD_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_Title_RD_HubPage"}, alwaysRun = true)
	public void verify_ArchiveDescription_RD_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_ArchiveDescription_RD_HubPage"}, alwaysRun = true)
	public void verify_SearchFilter_LinkWorking_RD_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_SearchFilter_LinkWorking_RD_HubPage"}, alwaysRun = true)
	public void verify_ViewMoreIn_LinkWorking_RD_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_ViewMoreIn_LinkWorking_RD_HubPage"}, alwaysRun = true)
	public void verify_SelectFilters_LinkWorking_RD_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_SelectFilters_LinkWorking_RD_HubPage"}, alwaysRun = true)
	public void verify_heroContainer_ImageWorking_RD_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_heroContainer_ImageWorking_RD_HubPage"}, alwaysRun = true)
	public void verify_heroContainer_LinkWorking_RD_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_heroContainer_LinkWorking_RD_HubPage"}, alwaysRun = true)
	public void verify_featuredPostsLinks_RD_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		...
		System.out.println("Total no of posts in 1by3 feature Category Container are: " + count);
	...
	@Test(dependsOnMethods = {"verify_featuredPostsLinks_RD_HubPage"}, alwaysRun = true)
	public void verify_featuredPostsImgs_RD_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_featuredPostsImgs_RD_HubPage"}, alwaysRun = true)
	public void verify_NewsletterSignUpPage_RD_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_NewsletterSignUpPage_RD_HubPage"}, alwaysRun = true)
	public void verify_Pagination_RD_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
