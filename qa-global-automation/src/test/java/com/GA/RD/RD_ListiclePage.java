...
public class RD_ListiclePage extends Driver{
	...
	@Test
	public void verifyTitle_RD_ListiclePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verifyTitle_RD_ListiclePage"}, alwaysRun = true)
	public void verifyLineTest_RD_ListiclePage() throws InterruptedException, IOException{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	/*@Test(dependsOnMethods = {"verifyLineTest_RD_ListiclePage"}, alwaysRun = true)
	public void verifyFacebookLink_RD_ListiclePage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verifyFacebookLink_RD_ListiclePage"}, alwaysRun = true)
	public void verifyTwitterLink_RD_ListiclePage() throws InterruptedException, IOException {
	...
	@Test(dependsOnMethods = {"verifyTwitterLink_RD_ListiclePage"}, alwaysRun = true)
	public void verifyPinteresttLink_RD_ListiclePage() throws InterruptedException, IOException {
	...
	*/
	@Test(dependsOnMethods = {"verifyLineTest_RD_ListiclePage"}, alwaysRun = true)
	public void verifyDekTest_RD_ListiclePage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verifyDekTest_RD_ListiclePage"}, alwaysRun = true)
	public void verifycardImage_RD_ListiclePage() throws InterruptedException, IOException {
	...
	@Test(dependsOnMethods = {"verifycardImage_RD_ListiclePage"}, alwaysRun = true)
	public void verifycardImageCredit_RD_ListiclePage() throws InterruptedException, IOException {
	...
	@Test(dependsOnMethods = {"verifycardImageCredit_RD_ListiclePage"}, alwaysRun = true)
	public void verifycardTitle_RD_ListiclePage() throws InterruptedException, IOException {
	...
	@Test(dependsOnMethods = {"verifycardTitle_RD_ListiclePage"}, alwaysRun = true)
	public void verifycardCaption_RD_ListiclePage() throws InterruptedException, IOException {
	...
	/*@Test(dependsOnMethods = {"verifycardCaption_RD_ListiclePage"}, alwaysRun = true)
	public void verifyCardCount_RD_ListiclePage() throws InterruptedException, IOException{
	...
	@Test(dependsOnMethods = {"verifycardCaption_RD_ListiclePage"}, alwaysRun = true)
	public void verifyTaboolaSidebar_RD_ListiclePage() throws InterruptedException, IOException{
	...
	@Test(dependsOnMethods = {"verifyTaboolaSidebar_RD_ListiclePage"}, alwaysRun = true)
	public void verifyTaboolaContainer_RD_ListiclePage() throws InterruptedException, IOException{
