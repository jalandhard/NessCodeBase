...
public class RD_HomePage extends Driver{
	...
	private By heroText = By.xpath("//div[@class='hero-text']//a[1]");     //a[1]/h2[1]");
	...
	private By SpotlightContainer = By.xpath("//div[@class='spotlight']//div[@class='one-big-three-small']//li//h4//a");  //div[@class='content']//div[3]//h4//a");  ////div[6]/ul[1]
	...
	*///video container
	...
	private By firstCustContainer = By.xpath("//div[@class='the-healthy-content']//div[@class='two-big-three-small']//h4//a"); //div[@class='two-big-three-small']//h4//a");
	private By firstCustomHeading = By.xpath("//div[@class='the-healthy-content']//h2//a");  //h2[@class='hp-section-heading healthy-hp-section']//a");     //img");
	private By firstCust_MoreBtn = By.xpath("//div[@class='two-big-three-small']/a[@class='hp-more-btn' and 1]");

	//Second Custom Container - 1 big and 3 Sm//h2[@class='hp-section-heading healthy-hp-section']//a//imgall modules
	private By secCustContainer = By.xpath("//div[@class='category-6']//h4//a"); //div[@class='content']/div[9]//h4//a"); //  //div[12]/ul[1]
	...
	//private By content2Ad = By.xpath("//iframe[@id='google_ads_iframe_/6178/rdg_desktop/homepage/content_2_0']");
	...
	@Test()
	public void verify_HeroContainerPost_LinkWorking_RD_HomePage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_HeroContainerPost_LinkWorking_RD_HomePage"}, alwaysRun = true)
	public void verify_HeroContainerPost_ImageWorking_RD_HomePage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_HeroContainerPost_ImageWorking_RD_HomePage"}, alwaysRun = true)
	public void verify_SpotLightSection_Posts_RD_HomePage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_SpotLightSection_Posts_RD_HomePage"}, alwaysRun = true)
	public void verify_VideoContainerAvailable_RD_HomePage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_VideoContainerAvailable_RD_HomePage"}, alwaysRun = true)
	public void verify_VideosRunning_RD_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		globalPage.verifyIsVideoRunning(videos, url);
	}

	@Test(dependsOnMethods = {"verify_VideosRunning_RD_HomePage"}, alwaysRun = true)
	public void verify_WatchMoreVideosLink_RD_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
...
//		globalPage.verifyIsElementWorking(moreVideosLink, url, element);
	...
	/*@Test(dependsOnMethods = {"verify_WatchMoreVideosLink_RD_HomePage"}, alwaysRun = true)
	public void verify_NativeSponsor_Container_RD_HomePage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_NativeSponsor_Container_RD_HomePage"}, alwaysRun = true)
	public void verify_NativeSponsor_PostWorking_RD_HomePage() throws IOException, InterruptedException {
...
*/
	...
	@Test(dependsOnMethods = {"verify_WatchMoreVideosLink_RD_HomePage"}, alwaysRun = true)
	public void verify_2Big3Small_Container_Heading_RD_HomePage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_2Big3Small_Container_Heading_RD_HomePage"}, alwaysRun = true)
	public void verify_2Big3SmallPosts_Available_RD_HomePage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_2Big3SmallPosts_Available_RD_HomePage"}, alwaysRun = true)
	public void verify_2Big3SmallContainer_MoreButtons_Available_RD_HomePage()throws IOException, InterruptedException{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_2Big3SmallContainer_MoreButtons_Available_RD_HomePage"}, alwaysRun = true)
	public void verify_1Big3SmallContainer_Heading_RD_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		driver.navigate().to(url);
		String element = "Second Custom Category heading ";
		/*globalPage.scrollToElement(firstCust_MoreBtn);
	...
	@Test(dependsOnMethods = {"verify_1Big3SmallContainer_Heading_RD_HomePage"}, alwaysRun = true)
	public void verify_1Big3SmallPosts_Available_RD_HomePage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_1Big3SmallPosts_Available_RD_HomePage"}, alwaysRun = true)
	public void verify_1Big3SmallContainer__MoreButtons_Availble_RD_HomePage()throws IOException, InterruptedException{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
