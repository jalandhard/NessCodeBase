...
public class RD_NavbarTests extends Driver{
	...
	private By SubscribeLink_header =By.xpath("//div[@class='subOffer_header_RD']//div[@class='offerText-container']//a"); 
...
//	private By searchIcon =By.xpath("//div[@id='search-form-wrapper']//input[@class='search-button']");  // By.className("search-button");  // By.className("search-button"); //button[@id='toh-search-toggle']
	...
	@Test
	public void verify_BrandLogo_RD() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_BrandLogo_RD"}, alwaysRun = true)
	public void NLSignUpImg_Header_RD() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"NLSignUpImg_Header_RD"}, alwaysRun = true)
	public void NLSignUpLink_Header_RD() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"NLSignUpLink_Header_RD"}, alwaysRun = true)
	public void verify_subsribleMagazineImg_Header_RD() throws IOException, InterruptedException {
		...
		//globalPage.verifyIsElementWorking_RD(heroText, url, element);
	...
	@Test(dependsOnMethods = {"verify_subsribleMagazineImg_Header_RD"}, alwaysRun = true)
	public void verify_headerNavBars_RD_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	/*@Test(dependsOnMethods = {"verify_headerNavBars_RD_HomePage"}, alwaysRun = true)
	public void compare_Header_Categories_RD_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		String element = "Header category link ";
		//Test Step
		globalPage.verifyheaderCategories(categoryLinks, url, element, Constant.RD_Headers);
		
	}*/
	
	@Test(dependsOnMethods = {"verify_headerNavBars_RD_HomePage"}, alwaysRun = true)
	public void verify_hamburgerMenu_Opened_RD_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_hamburgerMenu_Opened_RD_HomePage"}, alwaysRun = true)
	public void verify_hamburger_MainMenu_Categories_RD_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_hamburger_MainMenu_Categories_RD_HomePage"}, alwaysRun = true)
	public void verify_hamburgerMenusHavingChild_RD_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_hamburger_MainMenu_Categories_RD_HomePage"}, alwaysRun = true)
	public void verify_hamburgerMenusHavingNoChild_RD_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_hamburgerMenusHavingChild_RD_HomePage"}, alwaysRun = true)
	public void verify_hamburgerMenu_Closed_RD_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_hamburgerMenu_Closed_RD_HomePage"}, alwaysRun = true)
	public void verify_NavBar_CategoryLinks_RD_HomePage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		String element = "Header category link ";
		//Test Step
