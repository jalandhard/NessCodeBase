...
public class RD_FooterTests extends Driver {
	...
	private By newsletterSignUpButton = By.xpath("//div[@class='newsletter']//form");
	...
	String newspapaerSignUpLink = Constant.RD_NewspaperLink;
