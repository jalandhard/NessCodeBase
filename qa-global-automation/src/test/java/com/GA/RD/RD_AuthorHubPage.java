...
public class RD_AuthorHubPage extends Driver{
	//Initialize object using page factory method 
	ConfigFileReader configFileReader;
	public Logger APPLICATION_LOGS = LogManager.getLogger("AppLogger");

	//Test Data
	String url=Constant.RD_AuthorPage;
	String desiredURL = Constant.RD_AuthorPage;
	...
	//private By newsletterText = By.xpath("//div[@class='container']//div[@class='newsletter']");//By.xpath("//div[@class='nl-container']//div[@class='newsletter']");
	private By newsletterSignupInputField= By.xpath("//div[@class='nf-field-element']//input[@type='email']"); //By.xpath("//div[@class='nl-container']//input[@id='email']");
	...
	@Test()
	public void verify_Banner_RD_AuthorPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_Banner_RD_AuthorPage"}, alwaysRun = true)
	public void verify_AuthorDetails_RD_AuthorPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_AuthorDetails_RD_AuthorPage"}, alwaysRun = true)
	public void verify_HeroContainer_LinkWorking_RD_AuthorPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_HeroContainer_LinkWorking_RD_AuthorPage"}, alwaysRun = true)
	public void verify_HeroContainer_ImageWorking_RD_AuthorPage() throws IOException, InterruptedException {
	...
	/*@Test(dependsOnMethods = {"verify_HeroContainer_ImageWorking_RD_AuthorPage"}, alwaysRun = true)
	public void verify_HeroContainer_Excerpt_RD_AuthorPage() throws IOException, InterruptedException {
...
*/
	...
	@Test(dependsOnMethods = {"verify_HeroContainer_LinkWorking_RD_AuthorPage"}, alwaysRun = true)
	public void verify_5By1_featuredPostsLinks_RD_AuthorPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_5By1_featuredPostsLinks_RD_AuthorPage"}, alwaysRun = true)
	public void verify_5By1_featuredPostsImgs_RD_AuthorPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_5By1_featuredPostsImgs_RD_AuthorPage"}, alwaysRun = true)
	public void verifyFirst_4By2_featuredPostsLinks_RD_AuthorPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verifyFirst_4By2_featuredPostsLinks_RD_AuthorPage"}, alwaysRun = true)
	public void verifyFirst_4By2_featuredPostsImgs_RD_AuthorPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verifyFirst_4By2_featuredPostsLinks_RD_AuthorPage"}, alwaysRun = true)
	public void verifyFirst_4By2_featuredPostsExcerpts_RD_AuthorPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verifyFirst_4By2_featuredPostsExcerpts_RD_AuthorPage"}, alwaysRun = true)
	public void verifySec_4By2_featuredPostsLinks_RD_AuthorPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verifySec_4By2_featuredPostsLinks_RD_AuthorPage"}, alwaysRun = true)
	public void verifySec_4By2_featuredPostsImgs_RD_AuthorPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verifySec_4By2_featuredPostsImgs_RD_AuthorPage"}, alwaysRun = true)
	public void verifySec_4By2_featuredPostsExcerpts_RD_AuthorPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		Actions action = new Actions(driver);
	...
	@Test(dependsOnMethods = {"verifySec_4By2_featuredPostsExcerpts_RD_AuthorPage"}, alwaysRun = true)
	public void verify_4By1_featuredPostsLinks_RD_AuthorPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_4By1_featuredPostsLinks_RD_AuthorPage"}, alwaysRun = true)
	public void verify_4By1_featuredPostsImgs_RD_AuthorPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_4By1_featuredPostsImgs_RD_AuthorPage"}, alwaysRun = true)
	public void verify_4By1_featuredPostsExcerpts_RD_AuthorPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_4By1_featuredPostsExcerpts_RD_AuthorPage"}, alwaysRun = true)
	public void verify_Pagination_RD_AuthorPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		try
	...
	@Test(dependsOnMethods = {"verify_Pagination_RD_AuthorPage"}, alwaysRun = true)
	public void verify_NewsletterSignUpPage_RD_AuthorPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
