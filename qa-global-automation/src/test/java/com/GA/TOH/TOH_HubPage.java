...
public class TOH_HubPage extends Driver {
	...
	String desiredURL = Constant.TOH_HubPage;
    ...
    private By viewMoreIn= By.xpath("(//div[@class='menu-categories-v2-sidebar-container'])[2]//li//a");   //(//div[@class='archive-sidebar-section categories-v2-static-menu'])[2]");  
	...
	@Test
	public void verify_Banner_TOH_HubPage() throws IOException, InterruptedException{
	...
	@Test(dependsOnMethods = {"verify_Banner_TOH_HubPage"}, alwaysRun = true)
	public void verify_BreadCrumb_TOH_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_BreadCrumb_TOH_HubPage"}, alwaysRun = true)
	public void verify_Title_TOH_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_Title_TOH_HubPage"}, alwaysRun = true)
	public void verify_ArchiveDescription_TOH_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_ArchiveDescription_TOH_HubPage"}, alwaysRun = true)
	public void verify_SearchFilter_LinkWorking_TOH_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		...
		//globalPage.verifyPostsImages_Clickable(searchFilter, url);
		//globalPage.verifyLinkStatus(searchFilter, url, element);
	}
	
	@Test(dependsOnMethods = {"verify_SearchFilter_LinkWorking_TOH_HubPage"}, alwaysRun = true)
	public void verify_ViewMoreIn_LinkWorking_TOH_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		...
		globalPage.verifyLinkStatus(viewMoreIn, url, element);
	}
	
	@Test(dependsOnMethods = {"verify_ViewMoreIn_LinkWorking_TOH_HubPage"}, alwaysRun = true)
	public void verify_SelectFilters_LinkWorking_TOH_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	/*@Test(dependsOnMethods = {"verify_SelectFilters_LinkWorking_TOH_HubPage"}, alwaysRun = true)
	public void verify_BrowseByList_TOH_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_SelectFilters_LinkWorking_TOH_HubPage"}, alwaysRun = true)
	public void verify_heroContainer_ImageWorking_TOH_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_heroContainer_ImageWorking_TOH_HubPage"}, alwaysRun = true)
	public void verify_heroContainer_LinkWorking_TOH_HubPage() throws IOException, InterruptedException {
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_heroContainer_LinkWorking_TOH_HubPage"}, alwaysRun = true)
	public void verify_featuredPostsLinks_TOH_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		...
		//globalPage.verifyBrowseByList_TOH(feauredPostLinks, url);
	...
	@Test(dependsOnMethods = {"verify_featuredPostsLinks_TOH_HubPage"}, alwaysRun = true)
	public void verify_featuredPostsImgs_TOH_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	/*@Test(dependsOnMethods = {"verify_5By1_featuredPostsImgs_TOH_HubPage"}, alwaysRun = true)
	public void verify_4By2_featuredPostsLinks_TOH_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_4By2_featuredPostsLinks_TOH_HubPage"}, alwaysRun = true)
	public void verify_4By2_featuredPostsImgs_TOH_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_4By2_featuredPostsImgs_TOH_HubPage"}, alwaysRun = true)
	public void verify_4By1_featuredPostsLinks_TOH_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_4By1_featuredPostsLinks_TOH_HubPage"}, alwaysRun = true)
	public void verify_4By1_featuredPostsImgs_TOH_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_featuredPostsImgs_TOH_HubPage"}, alwaysRun = true)
	public void verify_NewsletterSignUpPage_TOH_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test(dependsOnMethods = {"verify_NewsletterSignUpPage_TOH_HubPage"}, alwaysRun = true)
	public void verify_Pagination_TOH_HubPage() throws IOException, InterruptedException
	{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
