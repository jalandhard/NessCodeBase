...
public class TOH_SubcatHubPage extends Driver {

	public class TOH_HubPage extends Driver {
		//Initialize object using page factory method 
		ConfigFileReader configFileReader;
		public Logger APPLICATION_LOGS = LogManager.getLogger("AppLogger");

		//Test Data
		String url=Constant.TOH_SubcatHubPage;
		String desiredURL = Constant.TOH_SubcatHubPage;
		String newspapaerSignUpLink = Constant.TOH_NewspaperSignUpLink;
		//String diyuLink = Constant.diyuLogoLink;

		//banner
		private By banner = By.xpath("//a[@class='pure-u-sm-1 pure-u-md-1-3 pure-u-lg-3-5 logo']");
		//Hero container
		...
		private By feauredPostLinks = By.xpath("//div[@class='pure-u-1 pure-u-sm-1-3 category-card']//a[1]");   //div[@class='recipe-content']/h2");
		private By feauredPostImgs = By.xpath("//div[@class='single-recipe']/a/div/img");
		...
		private By newsletterSignupButtonLocator=By.xpath("//div[@class='col-2 newsletter-signup']//form");  //By.xpath("(//div[@class='newsletter'])[1]//button[@id='subscribe']");//By.xpath("//div[@class='nl-container']//button[@id='subscribe']"); //By.xpath("//button[@class='at-element-click-tracking']"); //   //By.xpath("//button[@class='at-element-click-tracking']");
	    ...
	    private By viewMoreIn= By.xpath("//div[@class='archive-sidebar-section subcategories-list']//li[position()<=(last() - 2)]//a");     //   (//div[@class='menu-categories-v2-sidebar-container'])[2]//li//a");   //(//div[@class='archive-sidebar-section categories-v2-static-menu'])[2]");  
		...
		private By searchFilter = By.xpath("(//input[@class='tag_search_field'])[2]");    
		private By viewMoreIn= By.xpath("//div[@class='archive-sidebar-section subcategories-list']");  
		private By selectFilters=By.xpath("(//div[@class='archive-filters']/div/ul/li[@data-value='breads-rolls-pastries']/a)[2]"); 
		*/
		@BeforeClass
		...
		@Test
		public void verify_Banner_TOH_SubcatHubPage() throws IOException, InterruptedException{
		...
		@Test(dependsOnMethods = {"verify_Banner_TOH_SubcatHubPage"}, alwaysRun = true)
		public void verify_BreadCrumb_TOH_SubcatHubPage() throws IOException, InterruptedException {
			//Object Initialization
			GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		...
		@Test(dependsOnMethods = {"verify_BreadCrumb_TOH_SubcatHubPage"}, alwaysRun = true)
		public void verify_Title_TOH_SubcatHubPage() throws IOException, InterruptedException {
			//Object Initialization
			GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		...
		@Test(dependsOnMethods = {"verify_Title_TOH_SubcatHubPage"}, alwaysRun = true)
		public void verify_ArchiveDescription_TOH_SubcatHubPage() throws IOException, InterruptedException {
			//Object Initialization
			GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		...
		@Test(dependsOnMethods = {"verify_ArchiveDescription_TOH_SubcatHubPage"}, alwaysRun = true)
		public void verify_SearchFilter_LinkWorking_TOH_SubcatHubPage() throws IOException, InterruptedException {
			//Object Initialization
			GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
			...
			globalPage.verifyIsElementWorking_TOH(searchFilter, url, element);
		}

		@Test//(dependsOnMethods = {"verify_SearchFilter_LinkWorking_TOH_SubcatHubPage"}, alwaysRun = true)
		public void verify_ViewMoreIn_LinkWorking_TOH_SubcatHubPage() throws IOException, InterruptedException {
			//Object Initialization
			GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);

			//Test Step
			String element = "View More In:";
			//globalPage.verifyIsElementWorking_TOH(viewMoreIn, url, element);
			//globalPage.verifyPostsImages_Clickable(viewMoreIn, url);
			globalPage.brandLinksNavigation(viewMoreIn, url, element);
		}

		@Test(dependsOnMethods = {"verify_ViewMoreIn_LinkWorking_TOH_SubcatHubPage"}, alwaysRun = true)
		public void verify_SelectFilters_LinkWorking_TOH_SubcatHubPage() throws IOException, InterruptedException {
			//Object Initialization
			GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		...
		/*@Test(dependsOnMethods = {"verify_SelectFilters_LinkWorking_TOH_SubcatHubPage"}, alwaysRun = true)
		public void verify_BrowseByList_TOH_SubcatHubPage() throws IOException, InterruptedException {
			//Object Initialization
			GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
			...
			globalPage.verifyBrowseByList_TOH(browseBy, url);
		}*/

		@Test(dependsOnMethods = {"verify_SelectFilters_LinkWorking_TOH_SubcatHubPage"}, alwaysRun = true)
		public void verify_heroContainer_ImageWorking_TOH_SubcatHubPage() throws IOException, InterruptedException {
			//Object Initialization
			GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		...
		@Test(dependsOnMethods = {"verify_heroContainer_ImageWorking_TOH_SubcatHubPage"}, alwaysRun = true)
		public void verify_heroContainer_LinkWorking_TOH_SubcatHubPage() throws IOException, InterruptedException {
			//Object Initialization
			GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);

			//Test Step
			String element = "Hero Link";
			//globalPage.verifyIsElementWorking_TOH(heroTitle, url, element);
			globalPage.verifyPostsImages_Clickable(heroTitle, url);
			globalPage.verifyLinkStatus(heroTitle, url, element);
		}

		@Test(dependsOnMethods = {"verify_heroContainer_LinkWorking_TOH_SubcatHubPage"}, alwaysRun = true)
		public void verify_featuredPostsLinks_TOH_SubcatHubPage() throws IOException, InterruptedException
		{
			//Object Initialization
			GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		...
		@Test(dependsOnMethods = {"verify_featuredPostsLinks_TOH_SubcatHubPage"}, alwaysRun = true)
		public void verify_featuredPostsImgs_TOH_SubcatHubPage() throws IOException, InterruptedException
		{
			//Object Initialization
			GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		...
		/*@Test(dependsOnMethods = {"verify_5By1_featuredPostsImgs_TOH_SubcatHubPage"}, alwaysRun = true)
		public void verify_4By2_featuredPostsLinks_TOH_SubcatHubPage() throws IOException, InterruptedException
		{
			//Object Initialization
			GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
			...
			globalPage.verifyBrowseByList_TOH(feauredPostLinks_4by2Modules, url);
		}

		@Test(dependsOnMethods = {"verify_4By2_featuredPostsLinks_TOH_SubcatHubPage"}, alwaysRun = true)
		public void verify_4By2_featuredPostsImgs_TOH_SubcatHubPage() throws IOException, InterruptedException
		{
			//Object Initialization
			GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
			...
			globalPage.verifyPostsImages_Clickable_TOH(feauredPostImgs_4by2Modules, url);
		}

		@Test(dependsOnMethods = {"verify_4By2_featuredPostsImgs_TOH_SubcatHubPage"}, alwaysRun = true)
		public void verify_4By1_featuredPostsLinks_TOH_SubcatHubPage() throws IOException, InterruptedException
		{
			//Object Initialization
			GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
			...
			globalPage.verifyBrowseByList_TOH(feauredPostLinks_4by1Modules, url);
		}

		@Test(dependsOnMethods = {"verify_4By1_featuredPostsLinks_TOH_SubcatHubPage"}, alwaysRun = true)
		public void verify_4By1_featuredPostsImgs_TOH_SubcatHubPage() throws IOException, InterruptedException
		{
			//Object Initialization
			GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
			...
			globalPage.verifyPostsImages_Clickable_TOH(feauredPostImgs_4by1Modules, url); //Constant.heroImage
		}*/

		@Test(dependsOnMethods = {"verify_featuredPostsImgs_TOH_SubcatHubPage"}, alwaysRun = true)
		public void verify_NewsletterSignUpPage_TOH_SubcatHubPage() throws IOException, InterruptedException
		{
			//Object Initialization
			GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
		...
		@Test(dependsOnMethods = {"verify_NewsletterSignUpPage_TOH_SubcatHubPage"}, alwaysRun = true)
		public void verify_Pagination_TOH_SubcatHubPage() throws IOException, InterruptedException
		{
			//Object Initialization
			GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
