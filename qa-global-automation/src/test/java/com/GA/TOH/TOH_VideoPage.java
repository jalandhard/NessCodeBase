...
public class TOH_VideoPage extends Driver {
	...
	@Test
	public void verify_VideoPlayerContainer_TOH_VideoPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_VideoPlayerContainer_TOH_VideoPage"}, alwaysRun = true)
	public void verify_VideoFeaturedPlaylistLinks_TOH_VideoPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_VideoFeaturedPlaylistLinks_TOH_VideoPage"}, alwaysRun = true)
	public void verify_VideoPlaylistThumbnailImages_TOH_VideoPage() throws IOException, InterruptedException {
	...
	@Test//(dependsOnMethods = {"verify_VideoPlaylistThumbnailImages_TOH_VideoPage"}, alwaysRun = true)
	public void verify_VideoPlaylistSliders_TOH_VideoPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_VideoPlaylistSliders_TOH_VideoPage"}, alwaysRun = true)
	public void verify_PlaylistPreviousArrowBtn_TOH_VideoPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_PlaylistDots_TOH_VideoPage"}, alwaysRun = true)
	public void verify_PlaylistNextArrowBtn_TOH_VideoPage() throws IOException, InterruptedException {
	...
	@Test(dependsOnMethods = {"verify_PlaylistPreviousArrowBtn_TOH_VideoPage"}, alwaysRun = true)
	public void verify_PlaylistDots_TOH_VideoPage() throws IOException, InterruptedException {
